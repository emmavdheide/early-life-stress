...
#check residuals
plot(lm(PreMowLLL~Treatment, data=LLL_filtered)) #looks fine
...
#run an ANOVA
anova2025<-aov(lm(Pre.Mow.LLL~Treatment, data=LLL2025_filtered))

#check residuals
plot(lm(Pre.Mow.LLL~Treatment, data=LLL2025_filtered)) #looks fine
...
#run an ANOVA
anova2024<-aov(lm(PreMowLLL~Treatment, data=LLL2024_filtered))

#check residuals
plot(lm(PreMowLLL~Treatment, data=LLL2024_filtered)) #looks fine
